...
class CharityStatement extends StatefulWidget {
  const CharityStatement({super.key});

  @override
  State<CharityStatement> createState() => _CharityStatementState();
}

class _CharityStatementState extends State<CharityStatement> {
  @override
          ...
          TextButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => CharityFundClaimForm()));
              },
              child: Text(
                'Apply',
                style: customTextStyleW400size16(fontWeight: FontWeight.bold),
