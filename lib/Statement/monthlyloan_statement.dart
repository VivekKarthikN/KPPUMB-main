...
class MonthlyLoanDeductionStatement extends StatefulWidget {
  const MonthlyLoanDeductionStatement({super.key});

  @override
  State<MonthlyLoanDeductionStatement> createState() =>
      _MonthlyLoanDeductionStatementState();
}

class _MonthlyLoanDeductionStatementState
    extends State<MonthlyLoanDeductionStatement> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Monthly Loan Deduction Schedule",
